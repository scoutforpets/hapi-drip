...
exports.plugin = {
  ...
  register: async function (server, options) {
    ...
    Hoek.assert(token, 'Please supply a valid `token` in the hapi-drip plugin options.')
    Hoek.assert(accountId, 'Please supply a valid `accountId` in the hapi-drip plugin options.')
